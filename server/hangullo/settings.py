...
if IN_DEV:
    SERVER_EMAIL = "Hangullo Development <noreply-dev@hangullo.com>"
elif IN_STAGING:
    SERVER_EMAIL = "Hangullo Staging <noreply-staging@hangullo.com>"
else:
    SERVER_EMAIL = "Hangullo <noreply@hangullo.com>"
...
WSGI_APPLICATION = "hangullo.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "hangullo.core.pagination.PageNumberPagination",
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "../client/public/dist"),
]
STATICFILES_FINDERS = [
...
if config("USE_AWS_STORAGE", cast=bool, default=False):
    ...
    DEFAULT_FILE_STORAGE = "hangullo.utils.storages.PrivateMediaStorage"
    STATICFILES_STORAGE = "hangullo.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "hangullo.request": {"handlers": [], "level": "INFO", "propagate": True},
        "hangullo.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["hangullo"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://hangullo-staging.herokuapp.com", "https://hangullo.herokuapp.com"]
